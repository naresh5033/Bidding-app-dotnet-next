...
public class DbInitializer
{
    ...
    {
        //this using var key will allow us to dispose any of the services we used inside this createScope() once we finish with this method
    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        context.AddRange(auctions); // when we add AddRange the ef will keep the data(aution) in mem.
