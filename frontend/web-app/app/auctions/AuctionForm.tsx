...
export default function AuctionForm({ auction }: Props) {
    ...
    const { control, handleSubmit, setFocus, reset,
        formState: { isSubmitting, isValid } } = useForm({
            mode: 'onTouched' //means the validation will kicks in as soon as the focus in and focus out any of the fields
        });
    ...
    useEffect(() => {
        ...
        setFocus('make'); //on the 1st field. 
    ...
    return ( // make sure all of these form fields will match the auction created dto
